    ...
    <div id="tableShow" align="center">
    	<form id="searchForm">
			<table>
				<tr>
					<th>模块名</th>
					<td><select id="cc" class="easyui-combobox" name="testName"
						style="width: 160px;" data-options="editable:false">
					</select></td>
					<td>后面这里加上是否启动浏览器执行</td>
					<td><a href="javascript:runModel()"
						class="easyui-linkbutton" data-option="plain:true">运行结果</a></td>
				</tr>
			</table>
		</form>
...
$('#cc').combobox({
	...
	url:"/SSMiframe/getAllTc?page=1&rows=500",
    valueField:'testName',
    textField:'testName',
    panelHeight:'auto',
    editable:false//不可输入
